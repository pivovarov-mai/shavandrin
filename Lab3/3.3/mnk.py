...
if __name__ == "__main__":
    ...
    # printing
    print('----------------------------------------------------------------------------------------------')
    print(f'Coefficients in approximating polynomial of the first degree: {approximating_polynomial1}')
    print(f'Sum of quadratic errors for approximating polynomial of the first degree: {error1}')
    print('----------------------------------------------------------------------------------------------')
    print(f'Coefficients in approximating polynomial of the second degree: {approximating_polynomial2}')
